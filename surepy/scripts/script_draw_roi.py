...
To run the script::
    ...
    sc_draw_roi_mpl -d <directory> -t <file type> -i <roi file indicator> -r <region type>

Try for instance::

    sc_draw_roi_mpl -d "surepy/tests/test_data/five_blobs.txt" -t 1 -i "_roi" -r "ellipse"
