...
from surepy.scripts.script_test import _add_arguments as _add_arguments_test
...
def main(args=None):
    ...
    if returned_args.command:
        ...
        print("This is the command line entry point for surepy. Get more information with 'surepy -h'.")
