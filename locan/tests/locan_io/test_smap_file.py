...
def test_load_SMAP_header(caplog):
    ...
    # print(columns)
    assert columns == [
        'LLrel', 'PSFxnm', 'PSFxpix', 'PSFynm', 'PSFypix', 'local_background', 'channel', 'filenumber', 'frame',
        'iterations', 'locprecnm','logLikelihood', 'intensity', 'photerr', 'position_x', 'uncertainty_x', 'xpix',
        'xpixerr', 'position_y', 'uncertainty_y', 'ypix', 'ypixerr']
