...
def save_SMLM(
    ...
    manifest : locan.locan_io.locdata.manifest_pb2.Manifest | None
...
def load_SMLM_manifest(path: str | os.PathLike | IO) -> dict:
    """
...
def load_SMLM_header(path: str | os.PathLike | IO) -> list[str]:
    """
