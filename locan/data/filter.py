...
def select_by_region(locdata, region, loc_properties=None, reduce=True) -> LocData:
    """
...
# todo: implement
def select_by_image_mask(selection, mask, bins):
    """
    ...
    mask : Sequence
        binary image.
    bins : Bins
        Bins in units of localization coordinates.
...
def exclude_sparse_points(
    locdata, other_locdata=None, radius=50, min_samples=5
) -> LocData:
    """
...
def random_subset(locdata, n_points, replace=True, seed=None) -> LocData:
    """
